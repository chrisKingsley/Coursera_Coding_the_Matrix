...
## Task 17
L1 = [1,2,3,4,4,5] # <-- want len(L1) != len(list(set(L1)))
L2 = [5,4,3,2,1] # <-- same len(L2) == len(list(set(L2))) but L2 != list(set(L2))
...
base = 10
digits = set(range(10))
representation_dict = { base*base*x+base*y+z:[x,y,z] for x in digits for y in digits for z in digits }
